...
/*   Updated: 2024/10/30 10:06:32 by akoutate         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int store_smart_mallocs(void *ptr_to_add, int type) {
    t_node *head = globalizer_head(0, NULL, type);
    t_node *new_node = ft_lstnew8(ptr_to_add);
...
{
    t_node *current = globalizer_head(0, NULL, type);
    t_node *next;
    ...
    globalizer_head(1, NULL, type);  // Reset the head
}
